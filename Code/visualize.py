...
plt.plot(games, white_score, color='blue', label='Genetic Agent', linewidth=3)
plt.plot(games, black_score, color='red', label='Greedy Agent', linewidth=3)

# Add labels, legend, and title
plt.xlabel('Game Number')
plt.ylabel('Cumulative Score')
plt.title('Cumulative Scores Across 10000 Games')
plt.legend()
plt.grid(True)
plt.show()
